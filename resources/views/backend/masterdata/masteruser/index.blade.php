            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        var btn = `
                            <div class="btn-group">
                            <a href="${url_detail}" class="btn btn-sm btn-default modal-show detail" title="Detail User"><i class="mdi mdi-magnify"></i></a>
                        `

                        if(!['USR2000000000001SrkcfS'].includes(row.id)){
                            btn += `<a href="${url_edit}" class="btn btn-sm btn-default modal-show edit" title="Edit User"><i class="mdi mdi-pencil-outline"></i></a>`
                            btn += `<a href="${url_delete}" class="btn btn-sm btn-default delete" title="Delete User"><i class="mdi mdi-trash-can-outline"></i></a>`
                        }
