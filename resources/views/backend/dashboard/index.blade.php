...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="{{ asset('assets/backend') }}/dashboard/index.html" class="b-brand text-primary">
        <!-- ========   Change your logo from here   ============ -->
        <img src="{{ asset('assets/backend') }}/images/logo-dark.svg" class="img-fluid logo-lg" alt="logo">
      </a>
    </div>
    <div class="navbar-content">
      <ul class="pc-navbar">
        <li class="pc-item">
          <a href="{{ asset('assets/backend') }}/dashboard/index.html" class="pc-link">
        ...
        <li class="pc-item">
          <a href="{{ asset('assets/backend') }}/elements/bc_typography.html" class="pc-link">
            <span class="pc-micon"><i class="ti ti-typography"></i></span>
            <span class="pc-mtext">Typography</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="{{ asset('assets/backend') }}/elements/bc_color.html" class="pc-link">
            <span class="pc-micon"><i class="ti ti-color-swatch"></i></span>
            <span class="pc-mtext">Color</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="{{ asset('assets/backend') }}/elements/icon-tabler.html" class="pc-link">
        ...
        <li class="pc-item">
          <a href="{{ asset('assets/backend') }}/other/sample-page.html" class="pc-link">
      ...
      <div class="card text-center">
        <div class="card-body">
          <img src="{{ asset('assets/backend') }}/images/img-navbar-card.png" alt="images" class="img-fluid mb-2">
        ...
        <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative" style="max-height: calc(100vh - 215px)">
          <div class="list-group list-group-flush w-100">
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{{ asset('assets/backend') }}/images/user/avatar-2.jpg" alt="user-image" class="user-avtar">
                </div>
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{{ asset('assets/backend') }}/images/user/avatar-1.jpg" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{{ asset('assets/backend') }}/images/user/avatar-3.jpg" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
            ...
            <a class="list-group-item list-group-item-action">
              <div class="d-flex">
                <div class="flex-shrink-0">
                  <img src="{{ asset('assets/backend') }}/images/user/avatar-4.jpg" alt="user-image" class="user-avtar">
                </div>
                <div class="flex-grow-1 ms-1">
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        <div class="dropdown-header">
          <div class="d-flex mb-1">
            <div class="flex-shrink-0">
              <img src="{{ asset('assets/backend') }}/images/user/avatar-2.jpg" alt="user-image" class="user-avtar wid-35">
            </div>
      ...
      <div class="row">
        ...
        <div class="col-auto my-1">
          <ul class="list-inline footer-link mb-0">
            <li class="list-inline-item"><a href="{{ asset('assets/backend') }}/index.html">Home</a></li>
          </ul>
        </div>
      </div>
    </div>
