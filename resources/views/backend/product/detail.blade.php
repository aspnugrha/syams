  ...
  <div class="row">
    ...
    <div class="col-md-7">
      ...
      <button class="btn btn-default w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSablonType" aria-expanded="false" aria-controls="collapseSablonType" style="border: 1px solid #ddd;">
        <i class="mdi mdi-printer-3d-nozzle"></i> Sablon Type
      </button>
      <div class="collapse mt-2" id="collapseSablonType">
        <div class="border border-1 py-2 px-3 mb-3">
      ...
      <button class="btn btn-default w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSizeQty" aria-expanded="false" aria-controls="collapseSizeQty" style="border: 1px solid #ddd;">
        <i class="mdi mdi-ruler"></i> Size & Quantity
      </button>
      <div class="collapse mt-2" id="collapseSizeQty">
        <table class="w-100 table table-bordered">
          <tr>
            <td>Size Options</td>
      ...
      <button class="btn btn-default w-100 text-start" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBordir" aria-expanded="false" aria-controls="collapseBordir" style="border: 1px solid #ddd;">
        <i class="mdi mdi-wizard-hat"></i> Provide Bordir
      </button>
