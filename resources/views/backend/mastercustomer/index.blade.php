  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('api.master-customer.export') }}" method="POST" id="form-filter">
            @csrf
    ...
    function loadData(){
        table = $('#table-data').DataTable({
            ...
            ajax: {
                ...
                url: "{{ route('api.master-customer.load-data') }}",
                type: "POST",
            ...
            columns: [
                ...
                },
                {
                    ...
                    searchable: false,
                    render: function(data, type, row, meta) {
                        let url_detail = `{{ route('paneladmin.master-customer.show', ':id') }}`;
                            url_detail = url_detail.replace(':id', row.id);
                        let url_edit = `{{ route('paneladmin.master-customer.edit', ':id') }}`;
                            url_edit = url_edit.replace(':id', row.id);
                        let url_delete = `{{ route('paneladmin.master-customer.destroy', ':id') }}`;
                            url_delete = url_delete.replace(':id', row.id);

                        var btn = `
                            <div class="btn-group">
                                <a href="${url_detail}" class="btn btn-sm btn-default modal-show detail" title="Detail Customer"><i class="mdi mdi-magnify"></i></a>
                                <a href="${url_edit}" class="btn btn-sm btn-default modal-show edit" title="Edit Customer"><i class="mdi mdi-pencil-outline"></i></a>
                                <a href="${url_delete}" class="btn btn-sm btn-default delete" title="Delete Customer"><i class="mdi mdi-trash-can-outline"></i></a>
                            </div>`
