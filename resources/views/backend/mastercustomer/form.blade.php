<form class="w-100" action="{{ @$data->id ? route('paneladmin.master-customer.update', @$data->id) : route('paneladmin.master-customer.store') }}"
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name" value="{{ @$data ? $data->name : old('name') }}" disabled>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="email" class="form-control" name="email" id="email" placeholder="Enter Email" value="{{ @$data ? $data->email : old('email') }}" disabled>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" name="phone_number" id="phone_number" placeholder="Enter Phone Number" oninput="this.value=this.value.replace(/\D/g,'')" value="{{ @$data ? $data->phone_number : old('phone_number') }}" disabled>
