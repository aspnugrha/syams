...
.navbar-transparent {
    background-color: rgba(255, 255, 255, 0); /* transparan total */
...
/* --- Warna teks di kondisi transparan --- */
.navbar-transparent .nav-link,
.navbar-transparent .navbar-brand,
.navbar-transparent .navbar-toggler {
    /* color: #fff !important;  */
    /* ubah ke #000 jika background halamanmu putih */
}

/* --- Warna teks di kondisi putih --- */
...
/* Transisi lembut warna teks */
.navbar .nav-link {
    transition: color 0.4s ease;
}

/* --- Hamburger icon putih & hitam --- */
.navbar-toggler-icon {
...
<nav id="mainNavbar" class="navbar navbar-expand-lg fs-6 p-3 align-items-center fixed-top navbar-transparent">
{{-- <nav id="mainNavbar" class="navbar navbar-expand-lg text-uppercase fs-6 p-3 border-bottom align-items-center"> --}}
    <div class="container-fluid">
        <div class="row justify-content-between align-items-center w-100">
            ...
            <div class="col-auto">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-2 gap-lg-3 pe-3" style="font-weight: 500;">
                            ...
                            <li class="nav-item {{ request()->segment(1) == 'showcase' ? 'active' : '' }}">
                                <a class="nav-link {{ request()->segment(1) == 'showcase' ? 'active' : '' }}" href="{{ route('showcase') }}">Showcase</a>
                            </li>
                            {{-- <li class="nav-item {{ request()->segment(1) == 'sample' ? 'active' : '' }}">
                                <a class="nav-link {{ request()->segment(1) == 'sample' ? 'active' : '' }}" href="{{ route('sample') }}">Sample</a>
                            </li> --}}
                            <li class="nav-item {{ request()->segment(1) == 'order' ? 'active' : '' }}">
                                <a class="nav-link {{ request()->segment(1) == 'order' ? 'active' : '' }}" href="{{ route('order') }}">Order</a>
                            </li>
                            {{-- <li class="nav-item {{ request()->segment(1) == 'contact-us' ? 'active' : '' }}">
                                <a class="nav-link {{ request()->segment(1) == 'contact-us' ? 'active' : '' }}" href="{{ route('contact-us') }}">About</a>
                            </li> --}}
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle {{ in_array(request()->segment(1), ['about-us', 'contact-us', 'service']) ? 'active' : '' }}" href="#" id="dropdownHome" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">About</a>
                                <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownHome" style="font-size: 14px;">
                                    <li>
                                        <a href="{{ route('about') }}" class="dropdown-item item-anchor">About Us</a>
                                    </li>
                                    <li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle {{ in_array(request()->segment(1), ['privacy-policy', 'refund-policy', 'shipping-policy']) ? 'active' : '' }}" href="#" id="dropdownHome" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">Policies</a>
                                <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownHome" style="font-size: 14px;">
                                    <li>
                                        <a href="{{ route('policies', 'privacy') }}" class="dropdown-item item-anchor">Privacy Policy</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('policies', 'refund') }}" class="dropdown-item item-anchor">Refund Policy</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('policies', 'shipping') }}" class="dropdown-item item-anchor">Shipping Policy</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="col-auto center position-absolute start-50 translate-middle-x">
                ...
                <img src="{{ asset($company_profile && $company_profile->logo ? 'assets/image/upload/logo/'.$company_profile->logo : 'assets/image/logo-syams.png') }}" alt="{{ ($company_profile && $company_profile->name ? $company_profile->name : 'Syams Manufacturing') }} Logo" style="width: 30px">
                </a>
            </div>

            <div class="col-3 col-lg-auto d-none d-lg-block">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    handleNavbar(); // jalankan saat load pertama
