    ...
    <div class="container-fluid">
        <div class="row justify-content-between align-items-center w-100">
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-2 gap-lg-4 pe-3" style="font-weight: 500;">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownHome" style="font-size: 14px;">
                                    <li>
                                        <a href="index.html" class="dropdown-item item-anchor">About Us</a>
                                    </li>
                                    <li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownHome" style="font-size: 14px;">
                                    <li>
                                        <a href="index.html" class="dropdown-item item-anchor">Privacy Policy</a>
                                    </li>
                                    <li>
                                        <a href="index.html" class="dropdown-item item-anchor">Refund Policy</a>
                                    </li>
                                    <li>
                                        <a href="index.html" class="dropdown-item item-anchor">Shipping Policy</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="col-auto center position-absolute start-50 translate-middle-x">
                ...
                <img src="{{ asset($company_profile && $company_profile->logo ? 'assets/image/'.$company_profile->logo : 'assets/image/logo-syams.png') }}" alt="{{ ($company_profile && $company_profile->name ? $company_profile->name : 'Syams Manufacturing') }} Logo" style="width: 100px">
                </a>
            </div>
