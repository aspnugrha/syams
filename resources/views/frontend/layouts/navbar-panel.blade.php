      ...
      <div class="order-md-last">
        <div class="d-flex flex-column justify-content-center mb-3">
            <div class="w-100 d-flex justify-content-center">
                <img class="justify-content-center" src="{{ Auth::guard('customer')->user()->image ? asset('asset/image/upload/customer/'.Auth::guard('customer')->user()->image) : 'https://via.assets.so/img.jpg?w=400&h=300&bg=e5e7eb&text=+&f=png' }}" alt="Image Profile" style="width: 100px;height: 100px;object-fit: cover;">
            </div>
