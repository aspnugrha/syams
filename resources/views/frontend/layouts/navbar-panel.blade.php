        ...
        <div class="row justify-content-between align-items-center w-100">
            ...
            <div class="col-auto">
                ...
                <div class="col-3 col-lg-auto d-none d-lg-block">
                    ...
                    <li class="d-lg-none">
                        <a href="#" class="mx-2" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAccount"
                        aria-controls="offcanvasAccount">
                        <svg width="24" height="24" viewBox="0 0 24 24">
...
<div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasAccount" aria-labelledby="My Cart">
      ...
      <div class="order-md-last">
        <div class="d-flex flex-column justify-content-center mb-3">
            <div class="w-100 d-flex justify-content-center">
                <img class="justify-content-center" src="{{ Auth::guard('customer')->user()->image ? asset('assets/image/upload/customer/'.Auth::guard('customer')->user()->image) : 'https://via.assets.so/img.jpg?w=400&h=300&bg=e5e7eb&text=+&f=png' }}" alt="Image Profile" style="width: 100px;height: 100px;object-fit: cover;">
            </div>
            <h4 class="mt-3 text-center">{{ Auth::guard('customer')->user()->name }}</h4>
            <span class="text-center">{{ Auth::guard('customer')->user()->email }}</span>
        </div>

        <form id="form-logout">@csrf</form>
        <button class="w-100 btn btn-dark btn-lg" type="button" onclick="logout()" id="btn-logout">Logout</button>
      </div>
    </div>
</div>
