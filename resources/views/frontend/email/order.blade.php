...
@section('content')
    ...
    <div class="border-bottom" style="padding: 0 25px 80px 25px;">
        ...
        <p style="margin: 0 0 10px 0;font-size: 15px;">Thank you for ordering at {{ $company_profile->name ? $company_profile->name : 'Syams Manufacture' }}. Here are the details of your order :</p>
        ...
        <div style="width: 100%;display: flex;justify-content: center;margin-top: 50px;">
            <a href="{{ $url }}" target="_blank" class="btn">Order Details</a>
        </div>
    </div>
