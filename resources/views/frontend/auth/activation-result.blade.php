                ...
                <div class="collection-content p-4 m-0 m-md-5 text-dark">
                    ...
                    @else
                        @if ($data['status'] == 'activation-code')
                            ...
                            <p class="mb-4">{{ $data['message'] }}</p>
                            <div class="d-flex justify-content-center">
                                <a href="{{ route('activation') }}" class="btn btn-dark btn-lg text-uppercase w-100" style="width: 280px !important;">Activate Account</a>
                            </div>
                        @elseif ($data['status'] == 'email')
                            <h4 class="mb-4 mt-1">There is something wrong!</h4>
                            <p class="mb-4">{{ $data['message'] }}</p>
                            <div class="d-flex justify-content-center">
                                <a href="{{ route('register') }}" class="btn btn-dark btn-lg text-uppercase w-100" style="width: 280px !important;">Register Account</a>
                            </div>
                        @endif
                    @endif
                </div>
