...
class AuthController extends Controller
{
    public function login(){
        ...
        // $url = '';
        // return view('frontend.email.register', compact('customer', 'company_profile', 'url'));
    }
    ...
    public function loginProcess(Request $request){
        $cek_email = Customers::where('email', $request->email)->first();
    ...
    public function registerActivationProcess($email, $code){
        ...
        $cek_email = Customers::where('email', $email)->first();
        if($cek_email){
        ...
        return view('frontend.auth.activation-result', compact('data'));
    }
    ...
    public function setNewPassword($email, $code){
        ...
        return view('frontend.auth.forgot-password-result', compact('data'));
    }
